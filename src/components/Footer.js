...
function Footer() {
  return (
    <footer className="relative bg-indigo-900 text-white">
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">
              Universitas kami berkomitmen untuk memberikan pendidikan berkualitas dan menciptakan lingkungan belajar yang inovatif.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-4">Tautan Cepat</h3>
            <ul className="space-y-2">
              <li><Link to="/home" className="text-sm hover:text-indigo-200 transition-colors">Beranda</Link></li>
              <li><Link to="/ruangan" className="text-sm hover:text-indigo-200 transition-colors">Ruangan</Link></li>
              <li><Link to="/dosen" className="text-sm hover:text-indigo-200 transition-colors">Dosen</Link></li>
              <li><Link to="/mahasiswa" className="text-sm hover:text-indigo-200 transition-colors">Mahasiswa</Link></li>
              <li><Link to="/matakuliah" className="text-sm hover:text-indigo-200 transition-colors">Matakuliah</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>Kota Universitas, 12345</li>
              <li>Telp: (021) 123-4567</li>
              <li>Email: info@universitas.ac.id</li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-indigo-700 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            <a href="#" className="text-indigo-200 hover:text-white text-sm">Kebijakan Privasi</a>
            <a href="#" className="text-indigo-200 hover:text-white text-sm">Syarat dan Ketentuan</a>
          </div>
          <p className="mt-8 text-base text-indigo-200 md:mt-0 md:order-1">
            &copy; 2023 Universitas Kami. Hak Cipta Dilindungi.
          </p>
        </div>
      </div>
    </footer>
